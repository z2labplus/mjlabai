...
| Define Akochan F2 adapter/legal-action task | 04/06 | P0 | Akochan F1 Conditional Pass | state/action mapping, legal action validator, wrapper boundary, license guardrails and decision log schema specified before code | Planned: current next |
