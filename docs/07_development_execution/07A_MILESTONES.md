...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | MahJax bridge, linear imitation, mixed/multi-project updates, seeds-1/5 continuity and categorical MLP training are implemented/reviewed; the first shared four-project-seat raw-outcome update is implemented and awaits one code review; no production self-play, evaluation or strength claim approved |
