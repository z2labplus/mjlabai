...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | MahJax bridge through exact five-update/fixed-evaluation and raw/centered/standardized failure comparison is implemented/reviewed; `04AA` accepts four-rate sensitivity and its exact `20..51` zero-update evaluation extension is implemented with `-501/-650/-635/-501/-501`, awaiting one review; no rate selection, production self-play/evaluation or strength claim approved |
