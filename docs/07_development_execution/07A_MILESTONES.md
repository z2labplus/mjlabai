...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | Exact two-half-game continuous training is implemented with aggregate `-632->-634`; review must prohibit blind third-game scale-up and directly choose a different mechanism or human gate; no strength/P9-P12 yet |
