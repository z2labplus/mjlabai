...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | Exact norm-matched unit-gradient one-step update changes parameters but leaves both fixed windows unchanged at `-312/-1056`; lightweight review is current and no normalized-training or strength conclusion is approved |
