...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | First exact seat-0 half-game raw-return update is implemented with disjoint seed-1 negative evaluation; lightweight review must directly choose bounded variance/credit assignment or defer; no strength or P9-P12 yet |
