...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | First half-game update review is closed; exact two-half-game continuous training and two-seed disjoint evaluation is directly approved with expected aggregate `-632->-634`; no strength or P9-P12 yet |
