...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | Exact `04AQ` anonymous concentration summaries are implemented: alternate effective contributions/largest share are about 5.15/41.6% vs reference 12.06/16.0%. Lightweight review is current; filtering/reweighting/strength remain unapproved |
