...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | Two-half-game implementation is review-closed at synthetic-only evidence limit; lawful replay data and compute budget now require owner approval before material scale-up; no strength/P9-P12 yet |
