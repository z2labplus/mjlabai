...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | `04AS` review-closes unit-norm alignment and directly approves one norm-matched fixed-rate shared update plus existing-window evaluation; normalized training beyond that diagnostic and strength remain unapproved |
