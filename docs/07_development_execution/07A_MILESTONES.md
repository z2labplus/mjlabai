...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | Fixed two-pass policy-table update sequence is implemented with 101 tests passing and exact review next; no environment, self-play or production RL training approved |
