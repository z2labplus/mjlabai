...
| P6 | Data system | Build replay, feature, label and quality pipelines for training and evaluation | Supervised training and offline evaluation datasets can be generated | Docs-only scope / entry criteria defined; implementation not approved |
...
The next execution step is to define P6 data-source provenance and rights
