...
| P8 | Self-play reinforcement learning | Optimize toward Tenhou pt EV, placement and stable-dan objectives | RL checkpoint beats supervised checkpoint in the unified league | MahJax bridge through exact five-update/fixed-evaluation failure diagnostic is implemented/reviewed; raw/centered/standardized estimator comparison is implemented with `-454/-454/-490` and awaits one review; no estimator selection, production self-play/evaluation or strength claim approved |
