...
| Project model-output environment bridge | Encode only public decision-time observation and mask 87 project-owned linear model scores by environment legality | Exact 630-feature, 54,897-parameter untrained linear-policy round implemented; seed 0 terminates after 91 legal transitions; exact review next |
