...
| Bundled rule-policy environment bridge | Prove a pinned non-learned policy can select legal actions and reach one terminal raw outcome | Exact four-seat MahJax bundled rule-policy round approved in `04M`; direct implementation next |
