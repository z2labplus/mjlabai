...
| Bundled rule-policy environment bridge | Prove a pinned non-learned policy can select legal actions and reach one terminal raw outcome | Exact four-seat MahJax bundled rule-policy round implemented; seed 0 terminates after 54 legal transitions; exact code review next |
