...
| Proven local riichi environment path | Pin a maintained licensed environment exposing legal actions, state transition and observation | MahJax `v0.1.2` / commit `3f9cee1` / Apache-2.0 selected in `04J`; one public init/observe/legal-step integration smoke implemented and passing; exact review next |
