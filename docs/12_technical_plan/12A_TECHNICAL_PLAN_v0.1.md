...
```text
P6 data-system current-scope closure criteria review after minimal replay
schema acceptance.
...
`02P`; `02Q` selected a docs-only current-scope closure-criteria task and
`02R` defined those criteria without closing full P6 or current-scope P6.
...
P6 implementation = closed again except for docs-only current-scope closure-criteria review after acceptance.
Next = review P6 current-scope data-system closure criteria after minimal replay schema acceptance.
```
...
```text
Review P6 current-scope data-system closure criteria after minimal replay schema
acceptance.
```
...
task. It does not close full P6, close current-scope P6 or approve real
Tenhou, real haifu, external logs, platform data, parser, dataset reader, data
...
P6 task and `02R` defines those criteria for review. All parser, dataset reader, ingestion, feature
