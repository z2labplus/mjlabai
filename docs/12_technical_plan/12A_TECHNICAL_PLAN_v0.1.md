...
```text
P7 docs-only scope / entry criteria / first-task definition after post-full-P6
transition review in `12D`.
...
`docs/12_technical_plan/12D_POST_FULL_P6_TRANSITION_REVIEW.md` records that
the post-full-P6 transition review is complete. Full P6 is closed only for the
documented P6 data-system scope, and the next step may be only a docs-only P7
scope / entry criteria / first-task definition. This is not P7 implementation,
not P7 first-task execution and not P8-P12 entry approval. The next task must
not add production code, tests, fixtures, parser, dataset reader, ingestion,
...
post-full-P6 transition review is complete and selects the next docs-only task:
define P7 scope, entry criteria and first task before implementation. This is
not P7 implementation, not P7 first-task execution and not P8-P12 entry
approval.
