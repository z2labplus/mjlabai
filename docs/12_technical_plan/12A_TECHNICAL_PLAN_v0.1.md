...
defined those criteria and `02S` reviewed them with no blocker, without
closing full P6 or current-scope P6.
...
P6 task, `02R` defines those criteria and `02S` reviews them with no blocker.
All parser, dataset reader, ingestion, feature
