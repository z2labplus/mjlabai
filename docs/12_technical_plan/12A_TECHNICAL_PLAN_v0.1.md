...
Next = define P5 legal-action and invalid-action metric specification.
```
...
当前 `10_NEXT` 的下一步是 define P5 legal-action and invalid-action metric specification：
