...
P6 data-source provenance and rights inventory = defined for review before replay schema implementation.
P6 implementation = not yet open.
Next = review P6 data-source provenance and rights inventory before replay schema implementation.
```
