...
```text
P6 data-system docs-only planning.
P5 evaluation foundation is closed for the current synthetic/local scope.
P6 data-system implementation is not yet open.
...
P6 implementation = not yet open.
...
reviews it with no blocker while keeping implementation closed. The current
next task is a docs-only approval decision for the minimal P6 replay schema and
synthetic fixture implementation task, not P6 implementation.
