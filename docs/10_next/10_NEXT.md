...
- For the next step, fix only the real-exe cwd/runtime boundary needed by the wrapper and workflow, then rerun the manual `Akochan F2 Wrapper Real Exe Audit` workflow.
