...
```text
Prepare P6 minimal replay schema and synthetic fixture implementation proposal
for review before code. Do not execute P6 implementation directly. Do not
expand into replay schema code, replay fixture implementation, tests, data
ingestion, dataset readers, parsers, feature extraction, label generation,
...
- Current next work is P6 data-system docs-only proposal drafting for a minimal
