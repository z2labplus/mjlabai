...
- Current next work is P6 data-system docs-only replay schema boundary review: do not implement replay schema code, ingest data, train, tune, self-play or connect to real Tenhou.
