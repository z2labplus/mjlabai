...
The next project task is to define the P5 tiny benchmark harness boundary for legal-action rate, latency and fixed-position decisions before implementation.
```
...
Do not implement the harness yet, and do not expand beyond P5 boundary documentation into training, self-play, league evaluation, Tenhou integration, artifact upload, broad adapter work or P6-P12.
```
