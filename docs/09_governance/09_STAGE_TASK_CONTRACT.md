...
next docs-only task. It does not approve broader P7 implementation, training,
...
Next = define broader P7 evaluation dependency and model-strength evidence boundary before implementation
```
