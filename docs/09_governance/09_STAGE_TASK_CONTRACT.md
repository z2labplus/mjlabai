...
Broader P7 supervised dataset construction, split and leakage boundary = next docs-only definition task
Full P7 = not closed
...
Next = define broader P7 supervised dataset construction, split and leakage boundary before implementation
```
