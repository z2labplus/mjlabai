...
P6 data-system minimal implementation approval. P5 evaluation foundation is
closed for the current synthetic/local scope; general P6 implementation is not
open, and only the next exact minimal replay schema / project-authored
synthetic fixture task is approved.
