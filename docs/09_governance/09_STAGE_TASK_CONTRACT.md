...
Broader P7 actual feature extraction and label generation boundary = next docs-only definition task
Full P7 = not closed
...
Next = define broader P7 actual feature extraction and label generation boundary before implementation
```
