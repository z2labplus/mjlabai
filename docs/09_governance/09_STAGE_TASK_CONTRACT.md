...
P6 data-system minimal implementation review. P5 evaluation foundation is
...
task approved by `02N` is implemented and now awaits a docs-only review gate.
