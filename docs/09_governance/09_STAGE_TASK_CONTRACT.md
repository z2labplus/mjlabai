...
schema acceptance. P5 evaluation foundation is closed for the current
...
task and `02R` defined those criteria without closing full P6 or
current-scope P6.
